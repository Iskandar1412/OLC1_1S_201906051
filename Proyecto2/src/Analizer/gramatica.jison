...
.                     	{ 
							errores.push({ tipo: "Léxico", error: yytext, linea: yylloc.first_line, columna: yylloc.first_column+1 }); 
							return 'INVALID';
						} 
...
ENTRADA
	: ENTRADA ENTCERO 					{ if($2!=="") $1.push($2); $$=$1; }
	| ENTCERO 		 					{ if($1!=="") $$=[$1]; else $$=[]; }
;
...
FUNCIONBODY
	: TIPO id pabre pcierra labre INSTRUCCION lcierra 	   	   		  	   		{ $$ = INSTRUCCION.nuevaFuncion($2, null, $6, $1, this._$.first_line, this._$.first_column+1) }
...
METODOBODY
	: prvoid id pabre pcierra labre INSTRUCCION lcierra 	    				{ $$ = INSTRUCCION.nuevoMetodo($2, [], $6, this._$.first_line, this._$.first_column+1) }
...
EXECBODY
	: premain id pabre pcierra ptcoma 			  				{ $$ = INSTRUCCION.nuevoExec($2, null, this._$.first_line, this._$.first_column+1) }
	| premain id pabre LISTAVALORES pcierra ptcoma 				{ $$ = INSTRUCCION.nuevoExec($2, $4, this._$.first_line, this._$.first_column+1) }
	| premain error ptcoma 			  			  				{ $$ = ""; errores.push({ tipo: "Sintáctico", error: "Llamada de main no válida.", linea: this._$.first_line, columna: this._$.first_column+1 }); }
;
...
SENTENCIATRANSFERENCIA
	: prbreak ptcoma 				{ $$ = new INSTRUCCION.nuevoBreak(this._$.first_line, this._$.first_column+1) }
...
FOR
	: prfor pabre DEC_VAR EXPRESION ptcoma ACTUALIZACION pcierra labre INSTRUCCION lcierra 		{$9.push($6); $$ = new INSTRUCCION.nuevoFor($3, $4, $9, this._$.first_line,this._$.first_column+1)}
...
ACTUALIZACION
	...
	| id incremento {$$ = INSTRUCCION.nuevaAsignacion($1, { opIzq: { tipo: 'VAL_IDENTIFICADOR', valor: $1, linea: this._$.first_line, columna: this._$.first_column+1 }, opDer: { tipo: 'VAL_ENTERO', valor: 1, linea: this._$.first_line, columna: this._$.first_column+1 }, tipo: 'SUMA', linea: this._$.first_line, columna: this._$.first_column+1 }, this._$.first_line,this._$.first_column+1) }
	| id decremento {$$ = INSTRUCCION.nuevaAsignacion($1, { opIzq: { tipo: 'VAL_IDENTIFICADOR', valor: $1, linea: this._$.first_line, columna: this._$.first_column+1 }, opDer: { tipo: 'VAL_ENTERO', valor: 1, linea: this._$.first_line, columna: this._$.first_column+1 }, tipo: 'RESTA', linea: this._$.first_line, columna: this._$.first_column+1 }, this._$.first_line,this._$.first_column+1) }
;
...
IFELSE
	: prif pabre EXPRESION pcierra labre INSTRUCCION lcierra prelse labre INSTRUCCION lcierra 	{ $$ = new INSTRUCCION.nuevoIfElse($3, $6, $10, this._$.first_line,this._$.first_column+1) }
...
ELSEIF
	: prif pabre EXPRESION pcierra labre INSTRUCCION lcierra prelse CONTROLIF 		{ $$ = new INSTRUCCION.nuevoElseIf($3, $6, $9, this._$.first_line,this._$.first_column+1); }
...
SWITCH
	: prswitch pabre EXPRESION pcierra labre CASESLIST DEFAULT lcierra 		{ $$ = new INSTRUCCION.nuevoSwitch($3, $6, $7, this._$.first_line, this._$.first_column+1); }
...
CASESLIST
	: CASESLIST prcase EXPRESION dospuntos INSTRUCCION 		{ $1.push(new INSTRUCCION.nuevoCaso($3, $5, this._$.first_line, this._$.first_column+1)); $$=$1; }
...
DEFAULT
	: prdefault dospuntos INSTRUCCION 			{ $$ = new INSTRUCCION.nuevoCaso(null, $3, this._$.first_line, this._$.first_column+1); }
...
DEC_VAR
	...
	| id incremento ptcoma 		     	{$$ = INSTRUCCION.nuevaAsignacion($1, { opIzq: { tipo: 'VAL_IDENTIFICADOR', valor: $1, linea: this._$.first_line, columna: this._$.first_column+1 }, opDer: { tipo: 'VAL_ENTERO', valor: 1, linea: this._$.first_line, columna: this._$.first_column+1 }, tipo: 'SUMA', linea: this._$.first_line, columna: this._$.first_column+1 }, this._$.first_line,this._$.first_column+1) }
	| id decremento ptcoma 		     	{$$ = INSTRUCCION.nuevaAsignacion($1, { opIzq: { tipo: 'VAL_IDENTIFICADOR', valor: $1, linea: this._$.first_line, columna: this._$.first_column+1 }, opDer: { tipo: 'VAL_ENTERO', valor: 1, linea: this._$.first_line, columna: this._$.first_column+1 }, tipo: 'RESTA', linea: this._$.first_line, columna: this._$.first_column+1 }, this._$.first_line,this._$.first_column+1) }
...
DEC_VECT
	: TIPO_VECT id igual prnew TIPO cabre EXPRESION ccierra ptcoma 			{ $$ = INSTRUCCION.nuevoVector($1, $5, $2, $7, null, null, this._$.first_line, this._$.first_column+1) }
...
DEC_LIST
	: TIPO_LIST id igual prnew prlist menor TIPO mayor ptcoma 		  		{ $$ = INSTRUCCION.nuevaLista($1, $7, $2, null, this._$.first_line, this._$.first_column+1) }
...
CASTEO
	: pabre TIPO pcierra EXPRESION { $$ = new INSTRUCCION.nuevoCasteo($2, $4, this._$.first_line, this._$.first_column+1) }
;

TERNARIO
	: EXPRESION interrogacion EXPRESION dospuntos EXPRESION { $$ = new INSTRUCCION.nuevoTernario($1, $3, $5, this._$.first_line, this._$.first_column+1) }
;
...
FPRINT
	: prprint pabre EXPRESION pcierra ptcoma 	{$$ = new INSTRUCCION.nuevoImprimir($3, this._$.first_line,this._$.first_column+1)}
...
FTOLOWER
	: prtoLower pabre EXPRESION pcierra 		{$$ = new INSTRUCCION.toLower($3, this._$.first_line,this._$.first_column+1)}
;

FTOUPPER
	: prtoUpper pabre EXPRESION pcierra 		{$$ = new INSTRUCCION.toUpper($3, this._$.first_line,this._$.first_column+1)}
;

FLENGTH
	: prlength pabre EXPRESION pcierra 			{$$ = new INSTRUCCION.nuevoLength($3, this._$.first_line,this._$.first_column+1)}
;

FTRUNCATE
	: prtruncate pabre EXPRESION pcierra 		{$$ = new INSTRUCCION.nuevoTruncate($3, this._$.first_line,this._$.first_column+1)}
;

FROUND
	: prround pabre EXPRESION pcierra 			{$$ = new INSTRUCCION.nuevoRound($3, this._$.first_line,this._$.first_column+1)}
;

FTYPEOF
	: prtypeof pabre EXPRESION pcierra 			{$$ = new INSTRUCCION.nuevoTypeOf($3, this._$.first_line,this._$.first_column+1)}
;

FTOSTRING
	: prtoString pabre EXPRESION pcierra 		{$$ = new INSTRUCCION.nuevoToString($3, this._$.first_line,this._$.first_column+1)}
;

FTOCHARARRAY
	: prtoCharArray pabre EXPRESION pcierra 	{$$ = new INSTRUCCION.nuevoToCharArray($3, this._$.first_line,this._$.first_column+1)}
;

LLAMADA
	: id pabre LISTAVALORES pcierra 	{ $$ = INSTRUCCION.nuevaLlamada($1, $3, this._$.first_line, this._$.first_column+1) }
